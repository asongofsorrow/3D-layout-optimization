...
if __name__ == "__main__":
    ...
    for i in range(10):#反复测试3遍
        ...
        metrics = [get_metrics(res[0], res[4]) for res in [res_blf, res_rl, res_prop]]
        ...
        print("-" * 125)
        names = ["BLF-NSGA-II (General)", "RL-NSGA-II-HD (Adaptive)", "HD-NSGA-II (Proposed)"]

        for name, res, (hv, igd) in zip(names, [res_blf, res_rl, res_prop], metrics):
